      ...
      <el-col v-for="(record) in records" :key="record.id" :span="6">
        <el-card class="record-card" :hoverable="true">
          ...
          <template v-if="isEdit">
            <div class="actions">
              <el-button icon="el-icon-arrow-left" size="mini" @click="sortRecord(record.id, 'left')" />
              <el-button icon="el-icon-arrow-right" size="mini" @click="sortRecord(record.id, 'right')" />
              <el-button icon="el-icon-edit" size="mini" class="edit-button" @click="editRecord(record)" />
