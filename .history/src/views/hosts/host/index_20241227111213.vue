  ...
  <div class="host-manager">
    ...
    <el-card class="table-card">
      ...
      >
        ...
        <el-table-column label="主机名" prop="hostname" min-width="100">
        ...
        <el-table-column label="IP地址" min-width="120">
          <template slot-scope="{ row }">
            <div class="ip-info">
              <div v-if="row.privateIp" 私: class="ip-item">
                <i class="el-icon-office-building" />
                <span class="ip-text">{{ row.privateIp }}</span>
              </div>
              <div v-if="row.publicIp" 公: class="ip-item">
        ...
        <el-table-column label="配置信息" min-width="130">
          <template slot-scope="{ row }">
        ...
        <el-table-column label="最后检查时间" width="120">
          <template slot-scope="{ row }">
    ...
    >
      ...
      >
        ...
        <el-form-item label="AccessSecret" prop="accessSecret" width="120%">
          <el-input
            ...
            style="width: 100%"
          />
          <el-tooltip class="item" effect="dark" content="系统不会存储AccessKey，请同步完妥善保管" placement="top">
...
export default {
  ...
  data() {
    return {
      ...
      fileList: [],
      importVisible: false,
      uploadUrl: process.env.VUE_APP_BASE_API + '/api/cmdb/hosts/import',
      importing: false,
      importProgress: 0,
  ...
  // 初始化表单数据
    ...
    async fetchHosts() {
      ...
      try {
        ...
        console.log('格式化后的表格数据:', this.tableData)
      } catch (error) {
