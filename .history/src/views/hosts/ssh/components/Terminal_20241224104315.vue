    ...
    <div class="toolbar">
      ...
      <el-dropdown trigger="click" :disabled="!isConnected">
        ...
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item v-for="cmd in Object.values(historyCommandsObject)" :key="cmd" @click.native="sendCommand(cmd)">
            {{ cmd }}
          </el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
...
export default {
  ...
  methods: {
    ...
    updateHistoryCommands(data) {
      ...
      if (trimmedData && !this.historyCommandsObject[trimmedData]) {
        this.historyCommandsObject[trimmedData] = trimmedData
      }
    },
